...
package de.gematik.ti.erp.app.location.usecase
...
class GetLocationUseCase(
    ...
    sealed interface LocationResult {
        ...
        data object GeocoderNotAvailable : LocationResult
        data object CountryNotFound : LocationResult
        data class CountryNotInEU(val countryCode: String) : LocationResult
        data class CountryDetectionFailed(val e: Throwable) : LocationResult
    }
}
