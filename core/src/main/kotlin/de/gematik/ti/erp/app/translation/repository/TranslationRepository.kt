...
interface TranslationRepository {
    ...
    suspend fun enableConsentForLocalTranslation()

    suspend fun disableConsentForLocalTranslation()

    fun downloadLanguageModels(targetLanguage: String): Flow<LanguageDownloadState>

    fun isTranslationAllowed(): Flow<Boolean>

    fun getPossibleLanguageList(): List<String>
    ...
    fun getTargetLanguageTag(): Flow<String?>
