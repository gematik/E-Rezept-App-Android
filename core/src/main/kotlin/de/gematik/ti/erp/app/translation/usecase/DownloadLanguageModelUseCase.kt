...
class DownloadLanguageModelUseCase(
    ...
    suspend operator fun invoke(languageCode: String): Flow<LanguageDownloadState> =
        withContext(dispatcher) {
            repository.setTargetLanguageTag(languageCode.lowercase())
            repository.downloadLanguageModels(languageCode)
        }
}
