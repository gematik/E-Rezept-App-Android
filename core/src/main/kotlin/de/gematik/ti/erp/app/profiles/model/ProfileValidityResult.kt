...
/**
 * Represents the result of checking the validity of a profile's SSO token.
 *
...
data class ProfileValidityResult(val profile: ProfilesUseCaseData.Profile, val isValid: Boolean) {
    companion object {
         ...
         *
         * @param onValid Lambda to invoke if the profile is valid.
        ...
        /**
         * Suspends until the [StateFlow] emits a [UiState] containing profile data, then checks if the SSO token is valid.
         *
