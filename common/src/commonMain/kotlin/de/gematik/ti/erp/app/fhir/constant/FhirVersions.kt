...
object FhirVersions {
     ...
     */
    val SUPPORTED_TASK_VERSIONS = listOf("1.2", "1.3", "1.4") // TODO: Remove versions 1.2, 1.3 after 15 Jul 2025
     ...
     */
    val SUPPORTED_KBV_VERSIONS = listOf("1.0.2", "1.1.0")
    ...
    val TASK_KBV_META_PROFILE_REGEX = Regex("""https://fhir\.kbv\.de/StructureDefinition/KBV_PR_ERP_Bundle\|(\d+\.\d+\.\d+)""")
