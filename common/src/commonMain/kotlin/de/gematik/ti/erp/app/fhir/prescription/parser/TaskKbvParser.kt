...
import de.gematik.ti.erp.app.fhir.prescription.model.erp.FhirTaskDataErpModel.Companion.createFhirTaskDataErpModel
...
import de.gematik.ti.erp.app.fhir.prescription.model.original.FhirBundleMetaProfile.Companion.containsExpectedProfileVersionForTaskKbvPhase
...
import de.gematik.ti.erp.app.fhir.prescription.util.ParserUtil.findValueByUrl
...
class TaskKbvParser : BundleParser {
    ...
    override fun extract(bundle: JsonElement): FhirTaskDataErpModel? {
        return runCatching {
            bundle.containsExpectedProfileVersionForTaskKbvPhase() ?: run {
