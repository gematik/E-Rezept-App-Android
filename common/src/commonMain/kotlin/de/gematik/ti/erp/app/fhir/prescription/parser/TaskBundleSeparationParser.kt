...
import de.gematik.ti.erp.app.fhir.prescription.model.erp.FhirTaskPayloadErpModel
import de.gematik.ti.erp.app.fhir.prescription.model.erp.FirTaskKbvPayloadErpModel
import de.gematik.ti.erp.app.fhir.prescription.model.original.FhirBundle
import de.gematik.ti.erp.app.fhir.prescription.model.original.FhirMeta
import de.gematik.ti.erp.app.fhir.prescription.model.original.FhirMeta.Companion.getProfile
...
class TaskBundleSeparationParser : BundleParser {
    ...
    private fun isTaskResource(profileValues: List<String>): Boolean {
        val result = isFhirResource(profileValues, FhirConstants.TASK, FhirVersions.TASK_VERSION_REGEX)
        return result
    }
    ...
    private fun isKBVBundleResource(profileValues: List<String>): Boolean {
        val result = isFhirResource(profileValues, FhirConstants.KBV_BUNDLE, FhirVersions.KBV_VERSION_REGEX)
        return result
    }
}
