...
sealed interface ConsentState : ErpServiceState {
    ...
    sealed interface ValidState : ConsentState {
        data object UnknownConsent : ValidState
        data object Loading : ValidState
        data object NotGranted : ValidState
        data object Granted : ValidState
        data object Revoked : ValidState
    }

    companion object {
        fun ConsentState.isNotGranted(): Boolean =
            this is ValidState.NotGranted || this is ValidState.Revoked

        fun ConsentState.isConsentGranted(): Boolean =
            this is ValidState.Granted
    }
}
