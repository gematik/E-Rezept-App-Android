                ...
                .mapNotNull { idpAuthenticationData ->
                    val profile = profileRepository.getProfileById(profileId)
                        ...
                        .validateRequirementForLastAuthUpdateRequired { id, lastAuthenticated ->
                            launch { profileRepository.updateLastAuthenticated(id, lastAuthenticated) }
                        }
                    val ssoTokenScope = idpAuthenticationData.singleSignOnTokenScope

                    Napier.i(tag = "Authentication State", message = "ssoTokenScope for choosing authentication ${ssoTokenScope?.token?.token}")
