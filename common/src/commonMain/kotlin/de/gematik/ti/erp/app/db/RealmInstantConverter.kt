...
internal fun RealmInstant.toLocalDateTime(offset: ZoneOffset = ZoneOffset.UTC): LocalDateTime =
    LocalDateTime.ofEpochSecond(epochSeconds, nanosecondsOfSecond, offset)

internal fun LocalDateTime.toRealmInstant(offset: ZoneOffset = ZoneOffset.UTC) =
