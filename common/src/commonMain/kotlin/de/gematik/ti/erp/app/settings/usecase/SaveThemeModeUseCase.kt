 ...
 *
 * Persists the theme mode to SharedPreferences for retrieval across app sessions.
 *
 * ## Usage:
 * ```kotlin
 * val saveThemeModeUseCase = SaveThemeModeUseCase(themeDataStore)
 * saveThemeModeUseCase(ThemeMode.DARK)
 * ```
 *
