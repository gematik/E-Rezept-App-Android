...
val MEDICATION_SCHEDULE = MedicationSchedule(
    start = Instant.parse("2024-01-01T08:00:00Z").toLocalDate(),
    end = Instant.parse("2024-01-01T20:00:00Z").toLocalDate(),
    isActive = true,
    ...
    notifications = listOf(
        MedicationNotification(
            time = LocalTime(8, 0),
            dosage = MedicationDosage("tablet", "1"),
            id = "1234"
        )
    )
)
...
val medicationSchedule1 = MedicationSchedule(
    ...
    amount = scannedTaskAmount,
    notifications = listOf(
        MedicationNotification(id = "1", time = LocalTime(8, 0), dosage = MedicationDosage("Dosis", "1")),
        MedicationNotification(id = "2", time = LocalTime(12, 0), dosage = MedicationDosage("Dosis", "1"))
    )
)
...
val medicationSchedule2 = MedicationSchedule(
    ...
    notifications = listOf(
        MedicationNotification(id = "3", time = LocalTime(10, 5), dosage = MedicationDosage("Dosis", "1")),
        MedicationNotification(id = "4", time = LocalTime(18, 0), dosage = MedicationDosage("Dosis", "1"))
    )
)
