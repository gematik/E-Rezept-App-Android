...
import de.gematik.ti.erp.app.fhir.model.taskJson_vers_1_2
import de.gematik.ti.erp.app.fhir.model.taskJson_vers_1_3
...
class TaskMetadataParserTest {

    val parser = TaskMetadataParser()

    @Test
    fun `test parserFor_task_resource_version_1_2`() = runTest {
        val bundle = Json.parseToJsonElement(taskJson_vers_1_2)
        val result = parser.extract(bundle)
        assertEquals(taskMetaDataVersion_1_2, result)
    }

    @Test
    fun `test parserFor_task_resource_version_1_3`() = runTest {
