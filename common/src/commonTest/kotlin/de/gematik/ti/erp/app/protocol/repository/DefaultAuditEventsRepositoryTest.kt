...
class DefaultAuditEventsRepositoryTest {

    @MockK
    lateinit var remoteDataSource: AuditEventRemoteDataSource
    private lateinit var auditEventsRepository: DefaultAuditEventsRepository
    ...
    fun setUp() {
        ...
        auditEventsRepository = DefaultAuditEventsRepository(remoteDataSource)
    }
