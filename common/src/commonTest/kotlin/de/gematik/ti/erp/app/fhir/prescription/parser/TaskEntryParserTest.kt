...
import de.gematik.ti.erp.app.fhir.model.task_bundle_version_1_2
import de.gematik.ti.erp.app.fhir.model.task_bundle_version_1_3
...
class TaskEntryParserTest {
    ...
    fun `test parser for task bundle version 1_2`() = runTest {
        val bundle = Json.parseToJsonElement(task_bundle_version_1_2)
    ...
    fun `test parser for task bundle version 1_3`() = runTest {
        val bundle = Json.parseToJsonElement(task_bundle_version_1_3)
        val result = parser.extract(bundle)
