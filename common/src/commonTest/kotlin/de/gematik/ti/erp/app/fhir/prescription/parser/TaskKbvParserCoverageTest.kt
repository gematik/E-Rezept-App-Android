...
import de.gematik.ti.erp.app.fhir.model.insuranceInformationJson
import de.gematik.ti.erp.app.fhir.model.insuranceInformationJson110
...
class TaskKbvParserCoverageTest {
    ...
    fun `test parser for coverage 110`() = runTest {
        val coverage = Json.parseToJsonElement(insuranceInformationJson110)
        val fhirCoverageModel = coverage.getCoverage()
        val erpModel = fhirCoverageModel?.toErpModel()
