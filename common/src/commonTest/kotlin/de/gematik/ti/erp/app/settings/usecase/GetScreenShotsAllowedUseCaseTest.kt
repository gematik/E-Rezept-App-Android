...
class GetScreenShotsAllowedUseCaseTest {

    private lateinit var getScreenShotsAllowedUseCase: GetScreenShotsAllowedUseCase
    ...
    fun setup() {
        ...
        getScreenShotsAllowedUseCase = GetScreenShotsAllowedUseCase(settingsRepository)
    }

    @Test
    fun `get screenshots allowed should answer true`() = runTest {
        ...
        assertTrue { getScreenShotsAllowedUseCase().first() }
    }

    @Test
    fun `get screenshots allowed should answer false`() = runTest {
        coEvery { settingsRepository.general } coAnswers {
            flowOf(
                SettingsData.General(
                    latestAppVersion = SettingsData.AppVersion(0, ""),
        ...
        assertFalse { getScreenShotsAllowedUseCase().first() }
    }
}
