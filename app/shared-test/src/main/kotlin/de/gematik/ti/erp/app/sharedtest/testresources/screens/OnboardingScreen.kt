...
import de.gematik.ti.erp.app.sharedtest.testresources.config.TestConfig.WaitTimeout5Sec
...
class OnboardingScreen(private val composeRule: ComposeTestRule) :
    ...
    fun waitForSecondOnboardingPage() {
        composeRule.awaitDisplay(WaitTimeout5Sec, TestTag.Onboarding.DataTermsScreen)
    }

    fun waitForAnalyticsPage() {
        composeRule.awaitDisplay(WaitTimeout5Sec, TestTag.Onboarding.Analytics.ScreenContent)
    }
