...
internal class EuAvailabilityScreen(
...
fun EuAvailabilityScreenContent(
    ...
    Column(
        ...
        verticalArrangement = Arrangement.spacedBy(SizeDefaults.zero, Alignment.Top)
    ) {
        ...
        Spacer(modifier = Modifier.height(PaddingDefaults.ShortMedium))
