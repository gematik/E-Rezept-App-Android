...
package de.gematik.ti.erp.app.eurezept.domin.usecase
...
class GetEuPrescriptionsUseCase(
    ...
    private fun SyncedTaskData.SyncedTask.toEuPrescription(): EuPrescription {
        return EuPrescription(
            id = this.taskId,
            name = this.medicationName() ?: "Unknown Medication",
            type = if (this.isEuRedeemable) {
