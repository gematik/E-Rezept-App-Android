...
class DemoModeDataSource {
     ...
     */
    val oftenUsedPharmacies = MutableStateFlow(mutableListOf<OverviewPharmacyData.OverviewPharmacy>())
     ...
     */
    val communications = MutableStateFlow(mutableListOf<DemoModeProfileLinkedCommunication>())
     ...
     */
    val cachedPharmacies = MutableStateFlow(mutableListOf<CachedPharmacy>())
