...
@Stable
open class DosageInstructionBottomSheetScreenController(
...
@Composable
fun rememberDosageInstructionBottomSheetScreenController(
    taskId: String
): DosageInstructionBottomSheetScreenController {
