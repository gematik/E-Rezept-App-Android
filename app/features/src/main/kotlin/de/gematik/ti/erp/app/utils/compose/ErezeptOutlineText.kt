...
fun erezeptTextFieldColors(
    ...
    focusedTrailingIconColor: Color = AppTheme.colors.neutral700,
    focussedLabelColor: Color = AppTheme.colors.primary700,
    unfocusedLabelColor: Color = AppTheme.colors.neutral700,
    focussedBorderColor: Color = AppTheme.colors.primary700,
    unfocusedBorderColor: Color = AppTheme.colors.neutral700,
    disabledBorderColor: Color = AppTheme.colors.primary100,
    errorBorderColor: Color = AppTheme.colors.red700,
    focusedPlaceholderColor: Color = AppTheme.colors.neutral700,
    unfocusedPlaceholderColor: Color = AppTheme.colors.neutral700,
    ...
    focusedLeadingIconColor: Color = AppTheme.colors.neutral700,
    unfocusedLeadingIconColor: Color = AppTheme.colors.neutral700,
    disabledLeadingIconColor: Color = AppTheme.colors.neutral300,
    errorLeadingIconColor: Color = AppTheme.colors.red700
) =
    TextFieldColors(
        ...
        cursorColor = AppTheme.colors.neutral700,
        errorCursorColor = AppTheme.colors.red700,
        ...
        unfocusedTrailingIconColor = AppTheme.colors.neutral700,
        disabledTrailingIconColor = AppTheme.colors.neutral300,
        errorTrailingIconColor = AppTheme.colors.red700,
        focusedLabelColor = focussedLabelColor,
        unfocusedLabelColor = unfocusedLabelColor,
        disabledLabelColor = AppTheme.colors.neutral300,
        errorLabelColor = AppTheme.colors.red700,
        focusedPlaceholderColor = focusedPlaceholderColor,
        unfocusedPlaceholderColor = unfocusedPlaceholderColor,
        disabledPlaceholderColor = AppTheme.colors.neutral100,
        errorPlaceholderColor = AppTheme.colors.red700,
        focusedSupportingTextColor = AppTheme.colors.neutral700,
        unfocusedSupportingTextColor = AppTheme.colors.neutral700,
        disabledSupportingTextColor = AppTheme.colors.neutral100,
        errorSupportingTextColor = AppTheme.colors.red700,
        focusedPrefixColor = AppTheme.colors.neutral700,
        unfocusedPrefixColor = AppTheme.colors.neutral700,
        disabledPrefixColor = AppTheme.colors.neutral100,
        errorPrefixColor = AppTheme.colors.red700,
        focusedSuffixColor = AppTheme.colors.neutral700,
        unfocusedSuffixColor = AppTheme.colors.neutral700,
        disabledSuffixColor = AppTheme.colors.neutral100,
        errorSuffixColor = AppTheme.colors.red700
    )
