...
object TrackingScreenRoutes : NavigationRoutes {
    override fun subGraphName(): String = "demo-tracker"

    object DemoTrackerScreen : Routes(NavigationRouteNames.DemoTrackerScreen.name)
}
