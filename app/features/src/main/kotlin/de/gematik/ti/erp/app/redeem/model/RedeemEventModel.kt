...
object RedeemEventModel {
    data class ProcessStateEvent(
        val processStartedEvent: ComposableEvent<Unit>,
        val processEndEvent: ComposableEvent<Unit>,
        val onNotRedeemable: () -> Unit,
        val onProcessStarted: () -> Unit,
        val onProcessEnded: () -> Unit
    )
