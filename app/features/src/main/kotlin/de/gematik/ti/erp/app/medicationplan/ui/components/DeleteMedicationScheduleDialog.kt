...
@Composable
internal fun DeleteMedicationScheduleDialog(
    ...
    event.listen {
        dialogScaffold.show { dialog ->
            ErezeptAlertDialog(
                title = stringResource(id = R.string.remove_medication_schedule_dialog_header),
                bodyText = stringResource(R.string.remove_medication_schedule_dialog_body),
