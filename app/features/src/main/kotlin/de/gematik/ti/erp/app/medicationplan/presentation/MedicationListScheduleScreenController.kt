...
class MedicationListScheduleScreenController(
...
@Composable
fun rememberMedicationListScheduleScreenController(): MedicationListScheduleScreenController {
    val loadProfilesWithSchedulesUseCase by rememberInstance<LoadProfilesWithSchedulesUseCase>()
    return remember {
        MedicationListScheduleScreenController(
            loadProfilesWithSchedulesUseCase = loadProfilesWithSchedulesUseCase
        )
    }
}
