...
class MessagesRoutesBackStackEntryArguments(
    ...
    internal fun getSelectedMessage(): OrderUseCaseData.Message? =
        navBackStackEntry.arguments?.let { bundle ->
