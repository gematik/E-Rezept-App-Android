...
fun Context.isWritePermissionGranted(): Boolean = ContextCompat.checkSelfPermission(this, writeExternalStorage) == PackageManager.PERMISSION_GRANTED

@Composable
fun getWriteExternalStoragePermissionLauncher(
