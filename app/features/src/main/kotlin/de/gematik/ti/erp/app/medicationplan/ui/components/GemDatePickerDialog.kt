...
@Composable
internal fun GemDatePickerDialog(
    ...
    val datePickerState = rememberDatePickerState(
        initialSelectedDateMillis = initialSelectedDate.atStartOfDayIn(TimeZone.UTC).toEpochMilliseconds(),
