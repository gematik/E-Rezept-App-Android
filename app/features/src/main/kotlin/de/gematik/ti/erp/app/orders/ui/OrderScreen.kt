...
fun OrderScreen(
    ...
    val profileController = rememberProfilesController()
        ...
        order?.let {
            item(key = "prescriptions") {
                Column(
                    ...
                    it.prescriptions.forEachIndexed { index, prescription ->
                        Surface(
                            modifier = Modifier
                            ...
                            Row(
                                ...
                                val name = when (prescription) {
                                    is Prescription.ScannedPrescription ->
                                        prescription.name
                                            ?: "$titlePrepend ${prescription.index}"
                                    is Prescription.SyncedPrescription -> prescription.name ?: ""
                                    else -> ""
                                }
                                Text(
                                    name,
