...
internal fun DigaData.toDigaBfarmUiModel(): DigaBfarmUiModel {
    return DigaBfarmUiModel(
        iconUrl = iconUrl,
        iconId = iconId,
        contractMedicalServicesRequired = contractMedicalServicesRequired,
        additionalDevicesRequired = additionalDevicesList,
        maxCost = maxCost,
        handbookUrl = handbookUrl,
        helpUrl = helpUrl,
        supportedPlatforms = supportedPlatformsString,
