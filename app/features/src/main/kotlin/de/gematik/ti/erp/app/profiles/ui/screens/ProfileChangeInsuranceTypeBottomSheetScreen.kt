...
class ProfileChangeInsuranceTypeBottomSheetScreen(
    ...
    override fun Content() {
        ...
        val controller = rememberProfileChangeInsuranceTypeBottomSheetScreenController(
            profileId
        )
                ...
                onClickGKV = {
                    ...
                    navController.navigate(
                        ...
                        navOptions = navOptions {
                            popUpTo(ProfileRoutes.ProfileChangeInsuranceTypeBottomSheetScreen.route) {
                                inclusive = true
                            }
                        }
                    )
...
private fun ProfileChangeInsuranceTypeBottomSheetScreenContent(
    ...
    DefaultDrawerScreenContent(
        ...
        info = stringResource(R.string.profile_change_insurance_type_drawer_body),
        header = stringResource(R.string.profile_change_insurance_type_drawer_title),
...
@LightDarkPreview
@Composable
fun ProfileChangeInsuranceTypeBottomSheetScreenPreview() {
    PreviewAppTheme {
        ProfileChangeInsuranceTypeBottomSheetScreenContent(
            onClickGKV = {},
            onClickPKV = {}
