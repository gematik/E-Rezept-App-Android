...
import de.gematik.ti.erp.app.medicationplan.presentation.rememberDosageInstructionBottomSheetScreenController
...
import de.gematik.ti.erp.app.utils.compose.Subtitle1Text

class MedicationPlanDosageInfoBottomSheetScreen(
    ...
    override fun Content() {
        ...
        val controller = rememberDosageInstructionBottomSheetScreenController(taskId ?: "")
        ...
        UiStateMachine(
            ...
            onContent = { dosageInstruction ->
                MedicationPlanDosageInfoContent(dosageInstruction = dosageInstruction)
            },
            onEmpty = {
                ErrorScreenComponent()
            }
...
@Composable
private fun MedicationPlanDosageInfoContent(dosageInstruction: MedicationPlanDosageInstruction) {
...
private fun InfoContent(dosageText: String, body: String, footer: (@Composable () -> Unit)? = null) {
    Column(
        ...
        Subtitle1Text(stringResource(R.string.dosage_info_bottomsheet_header))
        Body2lText(dosageText)
        Body2lText(body)
        footer?.invoke()
    }
}
...
fun MedicationPlanDosageInfoContentPreview(
    ...
    PreviewAppTheme {
        MedicationPlanDosageInfoContent(previewData.dosageInstruction)
    }
}
