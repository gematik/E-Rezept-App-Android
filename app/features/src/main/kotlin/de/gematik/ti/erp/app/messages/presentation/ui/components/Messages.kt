...
import de.gematik.ti.erp.app.messages.presentation.ui.model.MessageDetailCombinedMessage
import de.gematik.ti.erp.app.messages.presentation.ui.model.MessageType.DISPENSE
import de.gematik.ti.erp.app.messages.presentation.ui.model.MessageType.IN_APP
import de.gematik.ti.erp.app.messages.presentation.ui.model.MessageType.INVOICE
import de.gematik.ti.erp.app.messages.presentation.ui.model.MessageType.REPLY
    ...
    val inAppMessageItems = inAppMessages.map { local ->
        MessageDetailCombinedMessage(
            ...
            message = OrderUseCaseData.Message(
                ...
                sentOn = Instant.parse(local?.timestamp.toString()),
            ...
            timestamp = Instant.parse(local?.timestamp.toString())
        )
    }
