...
@Composable
internal fun PharmacyServicesSection(labels: List<String>) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        FlowRow(
            ...
            labels.forEach { label ->
                PharmacyServiceChip(label = label)
            }
        }
    }
}
...
@Composable
internal fun PharmacyServiceChip(label: String) {
    Surface(
...
@LightDarkPreview
@Composable
internal fun PharmacyServicesSectionPreview() {
    PreviewAppTheme {
        PharmacyServicesSection(
            labels = PharmacyPreviewData.ALL_PRESENT_DATA.availableServices.map { it.code }
        )
    }
}
