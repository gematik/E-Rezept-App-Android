...
class AcceptIntegrityRiskUseCase(
    ...
    suspend operator fun invoke(acceptRiskEnum: AcceptRiskEnum) {
        withContext(dispatcher) {
            when (acceptRiskEnum) {
                AcceptRiskEnum.AcceptForSession -> session.acceptIntegrityForSession()
                AcceptRiskEnum.AcceptPermanent -> repository.acceptIntegrityNotOk()
            }
        }
    }
}
