...
object AppUpdateRoutes : NavigationRoutes {

    override fun subGraphName() = "app_update"

    object AppUpdateScreen : Routes(path = NavigationRouteNames.AppUpdateScreen.name)
}
