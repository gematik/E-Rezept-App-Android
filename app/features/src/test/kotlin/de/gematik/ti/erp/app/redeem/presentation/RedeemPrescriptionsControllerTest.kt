...
class RedeemPrescriptionsControllerTest {
    ...
    fun `success - direct redemption`() {
        ...
        testScope.runTest {
            ...
            controllerUnderTest.redeemedState.test {
                // initial state
                assertEquals(RedeemedPrescriptionState.Init, awaitItem())
                ...
                assert(prescriptionResultState is RedeemedPrescriptionState.Success)
    ...
    fun `failure - logged in redemption HTTP_BAD_REQUEST`() {
        ...
        testScope.runTest {
            ...
            controllerUnderTest.redeemedState.test {
                ...
                // results within the state
                val prescriptionResultState = (emittedState as RedeemedPrescriptionState.OrderCompleted).results.values.first()
                assert(prescriptionResultState is RedeemedPrescriptionState.Error)
                cancelAndIgnoreRemainingEvents()
            }
        }
    }
