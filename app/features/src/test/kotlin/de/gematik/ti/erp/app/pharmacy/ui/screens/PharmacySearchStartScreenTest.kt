...
class PharmacySearchStartScreenTest(config: ScreenshotConfig) : BaseScreenshotTest(config) {
...
class PharmacySearchStartScreenAccessibilityTest(config: ScreenshotConfig) : BaseAccessibilityTest(config) {
