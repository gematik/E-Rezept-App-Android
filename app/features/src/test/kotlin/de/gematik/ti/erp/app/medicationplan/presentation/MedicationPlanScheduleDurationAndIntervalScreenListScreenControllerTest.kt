...
class MedicationPlanScheduleDurationAndIntervalScreenListScreenControllerTest {

    private val profileRepository: ProfileRepository = mockk()
    private val defaultMedicationPlanRepository: DefaultMedicationPlanRepository = mockk()
    private val dispatcher = StandardTestDispatcher()
    private val testScope = TestScope(dispatcher)
    private lateinit var controllerUnderTest: MedicationPlanScheduleListScreenController
    private lateinit var getAllProfileWithSchedulesUseCase: GetAllProfileWithSchedulesUseCase
    ...
    fun setUp() {
        ...
        controllerUnderTest = MedicationPlanScheduleListScreenController(
            getAllProfileWithSchedulesUseCase = getAllProfileWithSchedulesUseCase
        )
    }
