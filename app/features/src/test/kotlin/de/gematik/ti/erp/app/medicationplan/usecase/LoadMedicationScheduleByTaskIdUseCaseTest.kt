...
class LoadMedicationScheduleByTaskIdUseCaseTest {
    ...
    private lateinit var useCase: GetMedicationScheduleByTaskIdUseCase
    ...
    fun setup() {
        ...
        useCase = GetMedicationScheduleByTaskIdUseCase(
            medicationPlanRepository = defaultMedicationPlanRepository
        )
        coEvery { defaultMedicationPlanRepository.getMedicationSchedule(any()) } returns flowOf(MEDICATION_SCHEDULE)
    }
