...
class Android8DeprecationScreenTest(config: ScreenshotConfig) : BaseScreenshotTest(config) {

    @Test
    fun screenShotTest() {
        paparazzi.snapshot {
            Android8DeprecationScreenPreview()
        }
    }
}

class Android8DeprecationAccessibilityTest(config: ScreenshotConfig) : BaseAccessibilityTest(config) {
