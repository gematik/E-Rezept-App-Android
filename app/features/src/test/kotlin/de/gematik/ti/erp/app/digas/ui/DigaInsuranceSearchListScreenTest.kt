 ...
 */
class DigaInsuranceSearchListScreenTest(config: ScreenshotConfig) : BaseScreenshotTest(config) {
    @Test
    fun screenShotTest() {
 ...
 */
class DigaInsuranceSearchListScreenAccessibilityTest(config: ScreenshotConfig) : BaseAccessibilityTest(config) {
    @Test
    fun screenShotTest() {
        val testParameters = InsuranceSearchListPreviewParameterProvider().values.toList()
        testParameters.forEach { data ->
