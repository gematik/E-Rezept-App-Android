...
class TranslationConsentBottomSheetScreenTest(config: ScreenshotConfig) : BaseScreenshotTest(config) {

    @Test
    fun screenShotTest() {
        paparazzi.snapshot {
            TranslationConsentContentPreview()
        }
    }
}

class TranslationConsentBottomSheetScreenAccessibilityTest(config: ScreenshotConfig) : BaseAccessibilityTest(config) {
