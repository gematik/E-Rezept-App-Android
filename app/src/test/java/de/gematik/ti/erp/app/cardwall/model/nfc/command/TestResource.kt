...
private const val RESOURCE_PREFIX = "src/test/res/nfc"
...
class TestResource {
    ...
    fun getParameter(parameterEnum: ParameterEnum): Any? {
        ...
        when (parameterEnum) {
            ParameterEnum.PARAMETER_FILEIDENTIFIER -> return FileIdentifier(ymlValue)
            ParameterEnum.PARAMETER_APPLICATIONIDENTIFIER -> return ApplicationIdentifier(ymlValue)
            ...
            ParameterEnum.PARAMETER_SID -> return ShortFileIdentifier(ymlValue)
        }
        return ymlValue
    }
