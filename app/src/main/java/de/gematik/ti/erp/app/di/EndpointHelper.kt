...
class EndpointHelper @Inject constructor(
    ...
    enum class EndpointUri(val original: String, val preferenceKey: String) {
        BASE_SERVICE_URI(BuildConfig.BASE_SERVICE_URI, "BASE_SERVICE_URI_OVERRIDE"),
        IDP_SERVICE_URI(BuildConfig.IDP_SERVICE_URI, "IDP_SERVICE_URI_OVERRIDE"),
        PHARMACY_SERVICE_URI(BuildConfig.PHARMACY_SERVICE_URI, "PHARMACY_BASE_URI")
    }
