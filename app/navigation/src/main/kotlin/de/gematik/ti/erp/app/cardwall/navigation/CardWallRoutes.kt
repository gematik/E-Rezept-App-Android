...
object CardWallRoutes : NavigationRoutes {
    ...
    const val CARD_WALL_NAV_GID_AUTH_INFO = "gidAuthInformation"
    ...
    object CardWallIntroScreen : Routes(
        ...
        fun path(profileIdentifier: ProfileIdentifier) = path(
            ...
            CARD_WALL_NAV_GID_AUTH_INFO to ""
        )
        ...
        fun pathWithGid(
            ...
            CARD_WALL_NAV_GID_AUTH_INFO to gidNavigationData.toNavigationString()
        )
    }
    ...
    fun NavBackStackEntry.processGidEventData(): GidNavigationData? {
        val authInfo = arguments?.getString(CARD_WALL_NAV_GID_AUTH_INFO)
