...
object TestTag {
    ...
    object Prescriptions {
        ...
        val PrescriptionProvided by tagName()
        val PrescriptionDeleted by tagName()
        val LocalRedeemScreen by tagName()
        ...
        object Details {
            ...
            val SubstitutionButton by tagName()
            ...
            val PrescriptionDetailBottomSheetTitle by tagName()
            val PrescriptionDetailBottomSheetDetail by tagName()
    ...
    object OfflineTranslation {
        val OfflineTranslationMenuSelect by tagName()
    }
    ...
    object Profile {
        ...
        val InvoiceShareScreen by tagName()
        val OpenTokensScreenButton by tagName()
        val InsurantName by tagName()
        val InsuranceName by tagName()
        ...
        object EditProfileIcon {
            ...
            val DeleteAvatarButton by tagName()
            val AvatarSelectorRow by tagName()
            val EmojiSaveButton by tagName()
        }
