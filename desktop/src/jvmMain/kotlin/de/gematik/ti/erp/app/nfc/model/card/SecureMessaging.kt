...
import de.gematik.ti.erp.app.nfc.model.command.EXPECTED_LENGTH_WILDCARD_SHORT
import de.gematik.ti.erp.app.nfc.model.command.ResponseApdu
import de.gematik.ti.erp.app.nfc.model.tagobjects.DataObject
import de.gematik.ti.erp.app.nfc.model.tagobjects.LengthObject
import de.gematik.ti.erp.app.nfc.model.tagobjects.MacObject
import de.gematik.ti.erp.app.nfc.model.tagobjects.StatusObject
...
class SecureMessaging(private val paceKey: PaceKey) {
    ...
    fun encrypt(commandApdu: CommandApdu): CommandApdu {
        ...
        Napier.d("Plain APDU: ${Hex.toHexString(apduToEncrypt)}")
        ...
        Napier.d("build encrypted command")
    ...
    fun decrypt(responseApdu: ResponseApdu): ResponseApdu {
        ...
        Napier.d("Encrypted Response APDU: ${Hex.toHexString(apduResponseBytes)}")
