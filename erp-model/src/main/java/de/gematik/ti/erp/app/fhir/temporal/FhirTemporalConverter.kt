...
package de.gematik.ti.erp.app.fhir.temporal
...
import de.gematik.ti.erp.app.fhir.temporal.FhirTemporalSerializationType.FhirTemporalLocalTime
import de.gematik.ti.erp.app.fhir.temporal.FhirTemporalSerializationType.FhirTemporalYear
import de.gematik.ti.erp.app.fhir.temporal.FhirTemporalSerializationType.FhirTemporalYearMonth
...
sealed interface FhirTemporal {
    ...
    data class YearMonth(
        val value: de.gematik.ti.erp.app.fhir.temporal.YearMonth,
    ...
    @SerialName("Year")
    data class Year(
        val value: de.gematik.ti.erp.app.fhir.temporal.Year,
    ...
    override fun selectDeserializer(element: JsonElement): KSerializer<out FhirTemporal> {
        val classType = element.jsonObject["type"]?.jsonPrimitive?.content
            ?: throw SerializationException(
                "FhirTemporalSerializer: key 'type' not found or does not match any module type"
            )
