...
@Serializable
data class FhirPharmacyErpModelCollection(
    val type: PharmacyVzdService,
    val total: Int,
    val id: String?,
    val entries: List<FhirPharmacyErpModel>
) : FhirErpModel {
...
@Serializable
data class FhirInsuranceProvider(val id: String, val name: String) : FhirErpModel
