...
import de.gematik.ti.erp.app.cardwall.model.nfc.CardUtilities.extractKeyObjectEncoded
import de.gematik.ti.erp.app.cardwall.model.nfc.card.CardKey
import de.gematik.ti.erp.app.cardwall.model.nfc.card.HealthCardVersion2
...
import de.gematik.ti.erp.app.cardwall.model.nfc.card.isEGK21
import de.gematik.ti.erp.app.cardwall.model.nfc.cardobjects.Ef
...
import de.gematik.ti.erp.app.cardwall.model.nfc.command.generalAuthenticate
import de.gematik.ti.erp.app.cardwall.model.nfc.command.manageSecEnvWithoutCurves
...
suspend fun NfcCardChannel.establishTrustedChannel(cardAccessNumber: String): PaceKey {
    ...
    suspend fun step1EphemeralPublicKeyFirst(
        ...
        Timber.d("nonceZBytes: %s", Hex.toHexString(nonceZBytes))
    ...
    suspend fun step2EphemeralPublicKeySecond(
        ...
        Timber.d("piccPk1Bytes: %s", Hex.toHexString(piccPk1Bytes))
    ...
    suspend fun step3MutualAuthentication(
        ...
        Timber.d("piccPk2: %s", Hex.toHexString(piccPk2Bytes))
    ...
    fun step4VerifyPcdAndPiccMac(
        ...
        Timber.d("macPiccBytes: %s", Hex.toHexString(piccMacBytes))
