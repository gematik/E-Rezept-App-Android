...
val networkModule = DI.Module("Network Module") {
    ...
    bindMultiton<String, HttpLoggingInterceptor>(PrefixedLoggerTag) { tagSuffix ->
    ...
    bindSingleton {
        ...
        val endpointHelper = instance<EndpointHelper>()
        val innerLoggingInterceptor = instance<String, HttpLoggingInterceptor>(PrefixedLoggerTag, "[inner request]")
        val outerLoggingInterceptor = instance<String, HttpLoggingInterceptor>(PrefixedLoggerTag, "[outer request]")
