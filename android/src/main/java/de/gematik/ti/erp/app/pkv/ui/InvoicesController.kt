...
class InvoicesController(
    ...
    val state
        @Composable
        get() = stateFlow.collectAsState(null)
    ...
    val isRefreshing
        @Composable
        get() = invoiceUseCase.refreshInProgress.collectAsState()
    ...
    suspend fun shareInvoicePDF(context: Context, invoice: InvoiceData.PKVInvoice) {
        ...
        sharePDFFile(context, file, subject)
    }
