...
@Serializable
data class DispensedEpaMedicationErpModel(
...
data class EpaContextualData(
    ...
    // epa specific (from fhir-specification, only 1 level is possible)
    val internalMedication: List<DispensedEpaMedicationErpModel> = emptyList()
)
