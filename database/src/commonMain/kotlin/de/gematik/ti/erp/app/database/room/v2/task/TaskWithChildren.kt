...
class TaskWithChildren {
    data class TaskWithChildren(
        ...
        @Relation(
            ...
            entity = MedicationDispenseEntityRoom::class
        )
        val medicationDispenses: List<MedicationDispenseEntityRoom> = emptyList(),
**/
        @Relation(
            parentColumn = "taskId",
            entityColumn = "taskId",
        ...
        val communications: List<ErpCommunicationEntity> = emptyList()
    )
}
