...
class IsFeatureToggleEnabledUseCase(
    private val featureToggleLocalDataSource: FeatureToggleLocalDataSource
) {
    operator fun invoke(featureEntity: FeatureEntity): Flow<Boolean> =
        featureToggleLocalDataSource.isFeatureEnabled(feature = featureEntity)
}
