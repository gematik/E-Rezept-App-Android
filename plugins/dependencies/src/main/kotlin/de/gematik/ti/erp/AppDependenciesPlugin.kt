...
class AppDependenciesPlugin : Plugin<Project> {
    ...
    object Dependencies {
        ...
        object DependencyInjection {
            fun kodein(module: String) = "org.kodein.di:kodein-$module:7.11.0"
        }
        ...
        object PlayServices {
            ...
            const val appReview = "com.google.android.play:review-ktx:2.0.0"
            const val appUpdate = "com.google.android.play:app-update-ktx:2.0.0"
        }
        ...
        object Android {
            ...
            object Test {
                const val runner = "androidx.test:runner:1.4.1-alpha07"
                const val orchestrator = "androidx.test:orchestrator:1.4.2-alpha04"
                const val services = "androidx.test.services:test-services:1.4.2-alpha04"
                const val archCore = "androidx.arch.core:core-testing:2.1.0"
                const val core = "androidx.test:core:1.4.1-alpha07"
        ...
        object Compose {
            ...
            fun accompanist(module: String) = "com.google.accompanist:accompanist-$module:0.23.0"
